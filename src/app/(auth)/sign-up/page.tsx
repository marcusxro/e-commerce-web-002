        ...
        <div className='min-h-screen flex flex-col lg:flex-row'>
            ...
            <div className='flex flex-col items-center justify-center gap-8 w-full lg:w-1/2 zpx-6 py-10'>
                <form className='w-full max-w-md'>
                    <h1 className='text-4xl font-bold text-black mb-6 text-center'>Sign Up</h1>
                  ...
                  <p>Already have an account? <span className='text-blue-500 cursor-pointer hover:text-blue-600'>Sign in here</span></p>
                  </div>
                </form>
            </div>
